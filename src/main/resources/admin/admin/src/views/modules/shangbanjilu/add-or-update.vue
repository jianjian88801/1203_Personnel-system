<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上班" prop="shangban">
          <el-input v-model="ruleForm.shangban" 
              placeholder="上班" clearable  :readonly="ro.shangban"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上班" prop="shangban">
              <el-input v-model="ruleForm.shangban" 
                placeholder="上班" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
          ...
          if(o=='shangban'){
            this.ruleForm.shangban = obj[o];
	    this.ro.shangban = true;
            continue;
          }
          if(o=='shijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shangbanjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangbanjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
