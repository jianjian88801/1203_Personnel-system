<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加班" prop="jiaban">
          <el-input v-model="ruleForm.jiaban" 
              placeholder="加班" clearable  :readonly="ro.jiaban"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加班" prop="jiaban">
              <el-input v-model="ruleForm.jiaban" 
                placeholder="加班" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiabanjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiabanjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
